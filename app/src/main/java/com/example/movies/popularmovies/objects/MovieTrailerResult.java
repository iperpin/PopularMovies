...
public class MovieTrailerResult implements Parcelable
{
    ...
    @Expose
    private String type;
    public final static Creator<MovieTrailerResult> CREATOR = new Creator<MovieTrailerResult>() {


        @SuppressWarnings({
            "unchecked"
        })
        public MovieTrailerResult createFromParcel(Parcel in) {
            return new MovieTrailerResult(in);
        }

        public MovieTrailerResult[] newArray(int size) {
            return (new MovieTrailerResult[size]);
        }

    }
    ;

    protected MovieTrailerResult(Parcel in) {
